...
<%
application.setAttribute("name2","홍길동");
...
즉 가장 가까운 보관소에서 먼저 찾는다.

<p>${name2}</p><br>
<p>PageContext: ${pageScope.name2}</p><br>
<p>ServletRequest: ${requestScope.name2}</p><br>
<p>HttpSession: ${sessionScope.name2}</p><br>
<p>ServletContext: ${applicationScope.name2}</p><br>
