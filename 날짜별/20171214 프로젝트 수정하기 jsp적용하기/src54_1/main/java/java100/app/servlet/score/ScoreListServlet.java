...
public class ScoreListServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("footer { text-align: center }");
        out.println("}");
        out.println("</style>");
        out.println("</head>");
        ...
        out.println("<a class='navbar-brand' href='../index.html'><img src='../images/bootstrap-solid.svg' width='30' height='30' alt=''>자바100기</a>");
        ...
        out.println("<a class='nav-link' href='../score/list'>성적<span class='sr-only'>(current)</span></a>");
        out.println("</li>");
