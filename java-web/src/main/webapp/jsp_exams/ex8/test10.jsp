...
java.util.HashMap<String, Object> maps = new java.util.HashMap<>();
maps.put("name","홍길동");
maps.put("age",20);
maps.put("working",true);
...
psname: ${pageScope.map["name"]}<br>
psage: ${pageScope.map["age"]}<br>
psworking: ${pageScope.map["working"]}<br>
name: ${map.name}<br>
age: ${map.age.}<br>
