...
public class MemberAddServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        out.println("<div class='col-sm-10'>");
        out.println("<input class='form-control' id='kor' type='text' name='email'>");
        out.println("</div>");
        out.println("</div>");
        
        out.println("<div class='form-group row'>");
        out.println("<label for='pwd' class='col-sm-2 col-form-label'>패스워드</label>");
        out.println("<div class='col-sm-10'>");
        out.println("<input class='form-control' id='pwd' type='password' name='pwd'>");
        out.println("</div>");
        out.println("</div>");
