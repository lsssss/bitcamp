...
<body>
	<div class='container'>
		...
		<h1>게시물 상세 정보</h1>
		<jsp:useBean id="board" type="java100.app.domain.Board"
		...
		<form action='update' method='post'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-10'>
					<input class='form-control' readonly id='regdate' type='text'
			...
			<div class='form-group row'>
				...
				<div class='col-sm-10'>
					...
					<input class='form-control' readonly id='cnt' type='number'
						name='cnt' value='${board.viewCount}'>
